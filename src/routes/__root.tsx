...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon.ico?v=zunexi-2", type: "image/x-icon" },
      { rel: "icon", href: "/favicon-32.png?v=zunexi-2", type: "image/png", sizes: "32x32" },
      { rel: "icon", href: "/favicon-zunexi.png?v=zunexi-2", type: "image/png", sizes: "512x512" },
      { rel: "apple-touch-icon", href: "/apple-touch-icon.png?v=zunexi-2", sizes: "180x180" },
